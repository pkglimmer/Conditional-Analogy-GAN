...
class TestModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        self.visual_names = ['xi', 'xij', 'yi', 'yj','alpha']
        # specify the models you want to save to the disk. The training/test scripts will call <BaseModel.save_networks> and <BaseModel.load_networks>
        self.model_names = ['G' + opt.model_suffix]  # only generator is needed.
        self.netG = cagan_networks.define_G(opt.input_nc, opt.output_nc, opt.ngf, opt.netG,
    ...
    def forward(self):
        ...
        # alpha = Lambda(lambda x: x[:,:,:,0:1])(self.fake_output)
        self.alpha = self.fake_output[:,0:1,:,:] 
        self.xij = self.fake_output[:,1:,:,:]
        self.xij = self.alpha * self.xij + (1-self.alpha) * self.xi # [64, 3, 128, 96]
